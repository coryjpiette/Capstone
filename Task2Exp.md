Milestone Task 2: Exploratory Data Analysis
================
Cory Piette
May 31, 2020
...
This script utilizes the tidy data principles applied to text mining as described in [Text Mining with R: A Tidy Approach](http://tidytextmining.com/).
